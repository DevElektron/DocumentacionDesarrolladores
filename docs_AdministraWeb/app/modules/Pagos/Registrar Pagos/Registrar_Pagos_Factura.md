...
4. Una vez seleccionada la factura, se habilitará la tabla principal, ahora indica la o las formas de pago que el cliente pagará la factura:
    ...
    - 4.4 Si eliges la forma de pago `EFECTIVO`, se habilitará el campo _RECIBÍ_, en la que tendrás que capturar la cantidad de efectivo recibida para pagar el o los montos de las formas de pago en efectivo.
...
Esta pantalla permite pagar una factura con más de una forma de pago (salvo que las formas de pagos prohiban su uso según datos capturados). Para agregar una forma de pago, tecleé la `flecha abajo`, y dependiendo de estatus del registro anterior capturado:  
...
Cuando se seleccione como forma de pago **7 - NOTA DE CREDITO** o **8 - SALDO A FAVOR** en los registros de pago de la tabla principal, aparecerá una ventana de lectura de código de barras de una N.A., en estos casos **NO se podrá escanear o teclear un código de barras de una Nota de Abono que NO sea del mismo cliente que la factura a pagar**.
...
- [ ] 9. Da clic en el botón **Aceptar**, y aparecerá un mensaje de confirmación: _**¿Estás seguro de que deseas guardar los registros de pago?**_, da clic en **No** para confirmar la información de pago de factura, da otra vez clic en **Aceptar** y ahora elige **Sí**, y aparecerá el mensaje de éxito: _**Pago(s) registrado(s) con éxito a la factura ###-######.**_, da clic en _Aceptar_ y se limpiará toda la información de la pantalla relativa al pago y a la factura.
...
- [ ] 7. Da clic en el botón **Aceptar** y aparecerá un mensaje de confirmación adicional: _**Seleccionó al menos una Forma de Pago que requiere Confirmación. ¿El pago fue APROBADO en la Terminal?**_, selecciona _SÍ_ y espera un momento para que los pagos sean confirmados, ya que esta forma de pago genera también una _**Factura de Comisión**_ por lo cuál el sistema requiere la fabricación y el timbrado de este nuevo documento fiscal, al finalizar pueden pasar uno de los siguientes resultados:
    1. **Pago exitoso con detalles. Se han registrado los pagos, pero con algunas observaciones. Revisa los detalles para más información**: El sistema ha registrado los pagos exitosamente, más el proceso de facturación ha reportado advertencias y/o errores, el diálogo permite desplegar tanto advertencias como errores, y cada registro se puede distinguir con UUID (formato ########-####-####-####-############) y/o el número de registro de pago del cual se refiere el contenido de la observación, estos datos son útiles para la localización del detalle del proceso de facturación.
    2. **Pago(s) registrado(s) con éxito a la factura ###-######**: Tanto el pago de la factura así como la facturación de comisión ha resultado correctos.
...
- [ ] 6. Completa los datos del registro (si es que te lo pide el mismo), y has clic en _Aceptar_, confirma la captura y la ventana te mostrará uno de 2 mensajes: el mensaje de éxito en tu pago de la factura (cuando la cantidad de la factura es cubierta por la Nota de Crédito escaneada), o el mensaje de que _la factura debe ser pagada completamente_ (el saldo de la Nota de Crédito no cubre el total) en que deberás de ingresar otra forma de pago para completar el pago de la factura.
...
- [ ] 4. Haz clic en la _x_ en la esquina superior derecha del manual para cerrarlo.
